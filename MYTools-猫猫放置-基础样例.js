...
(function () {
        ...
        const panelContent = `
            <div style="margin-bottom: 15px;">
                <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                    <button id="quick-harvest-all" style="background: #3498db; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">一键领取收货箱</button>
                </div>
            </div>
        `;
    ...
    async function processHarvestBoxItems() {
        ...
        addLog(`找到 ${unclaimedItems.length} 个未领取的收货箱项目`);
